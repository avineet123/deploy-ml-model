...
rootDir = os.path.abspath(os.path.join(curr_dir, '..'))
print(rootDir)
#PACKAGE_ROOT=Path(regression_model.__file__).resolve().parent
PACKAGE_ROOT=Path(rootDir)
...
def fetch_config_from_yaml(cfg_path:Optional[Path]=None)-> YAML:
    """Parse YAML COntaining Package Configuration"""
    if not cfg_path:
    ...
    raise Exception("DID NOT FIND CONFIG FILE AT PATH : {cfg_path}")
